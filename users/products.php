<?php
    ...
    if(isset($_POST['products-update']) && isset($_POST['update'])){
        ...
        $category = $_POST['category'];
        $sub_category = $_POST['sub_category'];
        $sql_create = "UPDATE products SET name=:product, image_url=:image_url, 
            image2_url=:image_url, image3_url=:image_url, units_price=:units_price,
            quantity=:quantity, descriptions=:descriptions, made_in=:made_in, 
            category_id=:category_id, sub_category_id=:sub_category_id WHERE product_id=:product_id";
        $statement = $conn->prepare($sql_create);
        ...
        if(isset($_FILES['image'])){
            ...
            $sql_create = "UPDATE products SET name=:product, units_price=:units_price,
            quantity=:quantity, descriptions=:descriptions, made_in=:made_in, 
            category_id=:category_id, sub_category_id=:sub_category_id WHERE product_id=:product_id";
        } 
        $sql_create = "UPDATE products SET name=:product, image_url=:image_url, 
        ...
        $statement->bindParam(':sub_category_id',$sub_category, PDO::PARAM_INT);
        $statement->execute();
        $_SESSION['success'] = "<strong>Producto</strong> actualizado com sucesso!";   
    }
?>
        ...
        <div class="page-breadcrumb bg-white">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title text-uppercase font-medium font-14">Productos</h4>
        ...
        <div class="container-fluid">
            ...
            <div class="row"> 
                ...
                <div class="col-lg-12 col-xlg-12 col-md-12">
                    ...
                    <?php endif;?>
                    <?php if(!isset($_POST['remove']) && !(isset($_POST['edit']) || isset($_GET['edit'])) && !(isset($_POST['more']) || isset($_GET['more']))):?>
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <div class="col-md-12 border-bottom p-0">
                                                <select name="sub_category" class="form-control p-2 border rounded" id="sub_category">
                                                    <?php
                                                        $sub_categories = findAll("sub_categories");
                            ...
                            <table id="products" class="display" width="100%">
                                <thead>
                                    <tr>            
                                        ...
                                        <th class="border-top-0 text-center">Producto</th>
                                        <th class="border-top-0 text-center">Preco</th>
                                        <th class="border-top-0 text-center">Quantidade</th>
                                        <th class="border-top-0 text-center">Made In</th>
                                        <th class="border-top-0 text-center">Categoria</th>
                                        <th class="border-top-0 text-center">Subcategoria</th>
                                        <th class="border-top-0 text-center">Accao</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php 
                                        $products = findAllAndJoinTables("products","category","sub_categories");
                                        foreach($products as $product):
                                    ?>
                                    <tr class="border-bottom">
                                        <td>
                                            <img height="75px;" src="assets/images/products/<?php echo $product->image_url;?>" class="img-responsive" alt="<?php echo $product->name;?>">
                                        </td>
                                        <td class="txt-oflo text-center"><?php echo $product->name;?></td>
                                        <td class="txt-oflo text-center"><?php echo number_format($product->units_price).".00Mt";?></td>
                                        <td class="txt-oflo text-center"><?php echo $product->quantity;?></td>
                                        <td class="txt-oflo text-center"><?php echo $product->made_in;?></td>
                                        <td class="txt-oflo text-center"><?php echo $product->category_name;?></td>
                                        <td class="txt-oflo text-center"><?php echo $product->sub_category_name;?></td>
                                        <td>
                                            <div class="row">
                                                <div class="col-md-12 col-sm-12 col-lg-12 justify-content-center" style="display: inline-flex;">
                                                    <form action="products?more=<?php echo $product->product_id;?>" method="post">
                                                        <input type="hidden" name="product_id" value="<?php echo $product->product_id;?>">
                                                        <input type="hidden" name="status" value="">
                                                        <button title="Detalhes" class="btn btn-success" type="submit" name="more"><i class="fa fa-plus"></i></button>
                                                    </form>
                                                    <form action="products?edit=<?php echo $product->product_id?>" method="post">
                                                        <input type="hidden" name="product_id" value="<?php echo $product->product_id?>">
                                                        <input type="hidden" name="status" value="">
                                                    ...
                                                    <form action="products" method="post">
                                                        <input type="hidden" name="product_id" value="<?php echo $product->product_id?>">
                                                        <input type="hidden" name="product_id" value="<?php echo $product->product_id?>">
                                                        <button title="Eleminar" class="btn btn-danger" type="submit" name="remove"><i class="fa fa-eye"></i></button>
                                                    </form>
                                                </div>
                                            </div>
                                        </td>
                    ...
                    <?php 
                        ...
                        $products = findOneCondiction("products","product_id",$product_id);
                        foreach($products as $product):
                    ?>
                    <!-- card begin -->
                    <div class="card">  
                        ...
                        <div class="card-body">
                            ...
                            <div class="bg-dark px-3 py-1 my-2">
                                <h4 class="text-white">EDICAO PRODUCTO</h4>
                            </div>
                            ...
                            <div class="row">
                                <!-- col-sm begin --> 
                                <div class="col-sm">
                                    <!-- Form edit product begin-->                             
                                    <form class="form-horizontal form-material" name="form-products" action="products" method="post" enctype="multipart/form-data">
                                        
                                        <div class="form-group mb-4">
                                            <div class="col-md-12 p-0">
                                                <input type="hidden" name="product_id" value="<?php echo $product_id;?>"
                                                    class="form-control p-2 border rounded" id="product_id"> 
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group mb-4">
                                            <label class="col-md-12 p-0" for="producto">Nome do producto</label>
                                            <div class="col-md-12 p-0">
                                                <input type="text" name="producto" value="<?php echo $product->name;?>"
                                                    class="form-control p-2 border rounded" id="producto"> 
                                            </div>
                                        </div> 
                                        <div class="custom-file mb-4">
                                            <input type="file" name="image" value="<?php echo $product->image_url;?>" class="custom-file-input" id="file">
                                            <label class="custom-file-label overflow-hidden" for="file" id="label-image"><?php echo $product->image_url;?></label>
                                        </div>                              
                                        <div class="form-group mb-4">
                                            <label for="description" class="col-md-12 p-0">Descricao producto</label>
                                            <div class="col-md-12 p-0">
                                                <textarea rows="6" name="description" class="form-control p-2 border rounded text-left" id="description"><?php echo $product->descriptions;?>
                                                </textarea> 
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row mb-4">
                                            <div class="col-sm">
                                                <label for="quantity" class="col-md-12 p-0">Quantidade</label>
                                                <div class="col-md-12 border-bottom p-0">
                                                    <input type="number" name="quantity" value="<?php echo $product->quantity;?>" placeholder="0" class="form-control p-2 border rounded" id="quantity">
                                                </div> 
                                            </div>
                                            ...
                                            <div class="col-sm">
                                                <label for="price" class="col-md-12 p-0">Preco Unitario</label>
                                                <div class="col-md-12 border-bottom p-0">
                                                    <input type="number" name="price" value="<?php echo number_format($product->units_price);?>.00" class="form-control p-2 border rounded" id="price">
                                                </div> 
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group mb-4">
                                            <label for="made-in" class="col-md-12 p-0">Fabricado em:</label>
                                            <div class="col-md-12 border-bottom p-0">
                                                <input type="text" name="made_in" value="<?php echo $product->made_in;?>" class="form-control p-2 border rounded" id="made-in">
                                            </div> 
                                        </div>
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <div class="col-md-12 border-bottom p-0">
                                                ...
                                                ?>
                                                    ...
                                                    <?php endif; if($sub_category->id != $product->sub_category_id):?>
                                                    <option selected value="<?php echo $category->id;?>">
                                                        <?php echo $category->category_name;?>
                                                    </option>
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <div class="col-md-12 border-bottom p-0">
                                                ...
                                                ?>
                                                    <option selected value="<?php echo $sub_category->id; ?>">
                                        ...
                                        <button type="reset" name="products" class="btn btn-danger float-right ml-2">Cancel</button>
                                        <button type="submit" name="products-update" class="btn btn-primary float-right">Salvar</button>                                    
                                    </form><!-- Form edit product end-->
                                </div> <!-- col-sm end --> 
                                <!-- col-sm begin --> 
                                <div class="col-sm">
                                    <div class="img mt-4">
                                        <img id="update" class="img-fluid" src="assets/images/products/<?php echo $product->image_url;?>" alt="<?php echo $product->name;?>">
                                    </div>
                                </div> <!-- col-sm end -->
                            </div><!-- row end -->
                            
                            <div class="row mt-3">
                                <div class="col-md-12 col-sm-12 col-lg-12 justify-content-end" style="display: inline-flex;">
                                    <form action="products?more=<?php echo $product->product_id;?>" method="post">
                                        <input type="hidden" name="product_id" value="<?php echo $product->product_id;?>">
                                        <input type="hidden" name="status" value="">
                                        <button title="Detalhes" class="btn btn-success" type="submit" name="more"><i class="fa fa-plus"></i></button>
                                    ...
                                    <form action="products" method="post">
                                        <input type="hidden" name="product_id" value="<?php echo $product->product_id?>">
                                        <input type="hidden" name="product_id" value="<?php echo $product->product_id?>">
                                        <button title="Eliminar" class="btn btn-danger" type="submit" name="remove"><i class="fa fa-eye"></i></button>
                                    </form>
                                </div>
                            </div>
                    ...
                    <?php 
                        if((isset($_POST['more']) || isset($_GET['more']))):
                    ...
                    <div class="card">  
                        ...
                        <div class="card-body">
                            ...
                            <div class="bg-dark px-3 py-1 my-2">
                                <h4 class="text-white">PRODUCTO DETALHES</h4>
                            </div>
